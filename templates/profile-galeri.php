      ...
      <div class="text-center card-box">
        <div class="member-card">
          <div class="thumb-xl member-thumb m-b-10 center-block">
            <img
              src="assets/local/images/lain.jpg"
          ...
          <div class="text-left m-t-40">
            ...
            <p class="text-muted font-13">
              ...
              ><span class="m-l-15">(123) 123 1234</span>
            </p>
            <p class="text-muted font-13">
              <strong>Email :</strong>
              <span class="m-l-15">johndoe@bootdey.com</span>
            </p>
            <p class="text-muted font-13">
          ...
          <div class="tab-content">
            <div class="tab-pane" id="home">
              <p class="m-b-5">
                ...
                type. Donec pede justo, fringilla vel, aliquet nec, vulputate
              ...
              <form role="form">
                ...
                <div class="form-group">
                  ...
                  <textarea
                    ...
                    class="form-control"
                  >
Loren gypsum dolor sit mate, consecrate disciplining lit, tied diam nonunion nib modernism tincidunt it Loretta dolor manga Amalia erst volute. Ur wise denim ad minim venial, quid nostrum exercise ration perambulator suspicious cortisol nil it applique ex ea commodore consequent.</textarea
                  >
                </div>
                <button
